...
/**
 * Converts between Vault's {@link AccountPermission} and Fulcrum's {@link EconomyPermission}.
 *
 * @author Bestialus
 * @version 1.0
 * @since   1.0
...
public class PermissionConverter {
  ...
  /**
   * Converts a Vault permission to a Fulcrum permission.
  ...
  /**
   * Converts a Fulcrum permission to a Vault permission.
   * @param permission the permission to convert
   * @return the converted permission
   */
  @Contract(pure = true)
