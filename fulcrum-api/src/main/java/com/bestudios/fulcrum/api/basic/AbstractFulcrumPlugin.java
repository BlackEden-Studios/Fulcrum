 ...
 */
public abstract class AbstractFulcrumPlugin extends JavaPlugin implements FulcrumPlugin {

  /** Default language id code used if none is specified in the configuration. */
  private final String DEFAULT_LANGUAGE = "en";

  /** Registry for commands*/
  private final CommandsRegistry<CommandTree, CommandWrapper> commandsRegistry;
  /** Registry for configurations*/
  private final ConfigurationsRegistry configurationsRegistry;
  /** Debug mode flag */
  private boolean debugMode = false;

  public AbstractFulcrumPlugin() {
   ...
   *
   * @see AbstractFulcrumPlugin#onDisable()
   */
  @Override
